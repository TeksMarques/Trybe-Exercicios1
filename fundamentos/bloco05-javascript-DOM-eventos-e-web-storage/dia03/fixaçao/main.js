...
firstLi.addEventListener('click', animacao );
secondLi.addEventListener('click', animacao);
thirdLi.addEventListener('click', animacao );
...
myWebpage.addEventListener('dblclick', function(){
    window.location.replace('https://teksmarques.github.io/');
})
